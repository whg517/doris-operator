...
// legacyVectorConfigTemplate is the exact Gen 2 operator-go v0.12.6 Vector pipeline.
// Keep it local while Doris preserves user-managed Vector sidecars during the v0.13 migration.
const legacyVectorConfigTemplate = `api:
	enabled: true
